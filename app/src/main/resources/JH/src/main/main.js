                ...
                return (
                  <li key={item.no}>
                    <div className="mbox-div">
                      <div
                        className="mbox-div-img"
                        onClick={() => setSelectedNo(item.no)}
                      >
                        <img
                          src={`http://qocrfenoqdxa16854260.cdn.ntruss.com/thumbnail/vod-category/${filepath}_01.jpg?type=f&w=240&h=250&ttype=jpg`}
                        ></img>
                      </div>
