...
function UPModal(props) {
  ...
  function insert() {
    ...
    axios
      .post("http://localhost/web/boards", formData)
      .then((response) => {
        ...
        <div className="upmodal">
          <div className="upmodal-content">
            ...
            >
              ...
              <button className="upmodal-text-cancel-btn" onClick={onClose}>
                Cancel
              </button>
              <button
                type="button"
                className="upmodal-text-create-btn"
                onClick={insert}
              >
                Create
              </button>
